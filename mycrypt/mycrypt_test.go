...
func TestKrypter(t *testing.T) {
	...
	tests := []test{
		...
		{inputMessage: []rune("Kjevik;SN39040;18.03.2022 01:50;6"), chiffer: 4, want: []rune("anizmo bc7;484 5:K47K6466d45N94 .")},
		{inputMessage: []rune("anizmo bc7;484 5:K47K6466d45N94 ."), chiffer: len(ALF_SEM03) - 4, want: []rune("Kjevik;SN39040;18.03.2022 01:50;6")},
	}
